...
function r(
  ...
  return {
    ...
    goodExamples,
    memoryRule,
    feedbackTemplates: essayFeedback
  };
}
...
const ansvarig = c("ansvarig", "personuppgiftsansvar", ["personuppgiftsansvarig", "biträde", "personuppgiftsbiträde", "dpa", "ansvar"]);
...
export const FOKUS_RUBRICS: Record<string, Rubric> = {
  ...
  "essay-konkurrent-positionering": r(
    ...
    ["konkurrent", "differentiering", "kundnytta"],
    ["substitut", "bevis"],
    "Positionering måste vara tydlig för kunden och möjlig att bevisa.",
    ["Bolaget nischar sig mot HR-onboarding och bevisar skillnaden med pilot och mätning."]
  ),
  ...
  "essay-foretagsform-trovardighet": r(
    ...
    ["risk", "avtal"],
    "Företagsform är ett affärsval, inte bara juridisk etikett.",
    ["AB kan passa om ansvar, kundavtal och trovärdighet väger tungt."]
  ),
  ...
  "essay-mal-kpi-bsc": r(
    "essay-mal-kpi-bsc",
    [bsc, mal, kpi, perspektiv, beslut],
    ["bsc", "mal", "kpi"],
    ["perspektiv", "beslut"],
    "Bra KPI:er visar framdrift mot målet.",
  ...
  "essay-halso-essiq-jamforelse": r(
    ...
    ["jamforelse", "economyMix", "slutsats"],
    ["arsredovisning", "forvaltning"],
  ...
  "essay-konsultbudget-scenario": r(
    ...
    ["budget", "scenario", "likviditet"],
    ["prognos", "belaggning", "pris"],
    "Budget blir användbar när antaganden testas i scenarier.",
    ["80 procent debiteringsgrad kan bära kalkylen, men 60 procent och sen betalning pressar likviditeten."]
  ),
  ...
  "essay-avtalskarta-it": r(
    ...
    [avtal, scope, ansvar, sekretess, gdpr, sla, risk],
    ["avtal", "scope", "ansvar"],
    ["sekretess", "gdpr", "sla", "risk"],
    "Avtal ska minska oklarhet om scope, ansvar, pris, data och support.",
    ["Uppdragsavtal, DPA, NDA och SLA kan behövas beroende på projektet."]
  ),
  "essay-gdpr-data-ansvar": r(
    "essay-gdpr-data-ansvar",
    [gdpr, ansvarig, sakerhet, avtal, risk, trov],
    ["gdpr", "ansvarig", "risk"],
    ["sakerhet", "avtal", "trovardighet"],
    "GDPR är affärsrisk: ansvar, dataflöden och säkerhet måste vara tydliga.",
    ["Om konsulten får kundregister behövs DPA, åtkomststyrning och incidentrutiner."]
  ),
  "essay-sla-support-efterleverans": r(
    "essay-sla-support-efterleverans",
    [sla, support, kundnytta, aterkommande, avtal, ansvar],
    ["sla", "support", "kundnytta"],
    ["aterkommande", "avtal", "ansvar"],
    "Efterleverans kan skapa trygghet för kunden och återkommande intäkt för bolaget.",
    ["Support med svarstid och ansvar gör leveransen tryggare och kan säljas månadsvis."]
  ),
  ...
  "essay-lagkonjunktur-paketering": r(
    ...
    [lagkonjunktur, paketering, besparing, kundnytta, risk],
    ["lagkonjunktur", "paketering", "besparing"],
    ["kundnytta", "risk"],
    "I lågkonjunktur måste erbjudandet kännas nödvändigt och ekonomiskt rimligt.",
    ["Sälj effektivisering och snabb payback, inte allmän digital transformation."]
  ),
  "essay-sticka-ut": r(
    "essay-sticka-ut",
  ...
  "essay-kopa-nu": r(
    "essay-kopa-nu",
    [bradska, alternativkostnad, kundnytta, risk, beslut],
    ["bradska", "alternativkostnad", "kundnytta"],
    ["risk", "beslut"],
    "Köp nu-argumentet ska visa kostnaden eller risken med att vänta.",
    ["Om väntan kostar 30 timmar per månad blir ett startprojekt lättare att motivera."]
  ),
  ...
  "essay-presentation-roda-traden": r(
    ...
    ["rodtrad", "problem", "kundnytta"],
    ["analys", "intakter", "avtal", "matbar"],
    "En stark presentation går från problem till lösning, bevis, ekonomi och riskhantering.",
    ["Problem, M365-lösning, SWOT/PESTELID, projektpris plus support, DPA/SLA och sparad tid ger röd tråd."]
  ),
  "essay-helhetscase": r(
    "essay-helhetscase",
    [kund, problem, kundnytta, analys, affarsmodell, intakter, budget, avtal, kpi, risk],
    ["kundnytta", "analys", "affarsmodell", "riskAgreementMix"],
    ["kund", "problem", "intakter", "budget", "kpi"],
    "Helhetscase = kundproblem, analys, affärsmodell, ekonomi, avtal och effekt.",
    ["Ett M365-bolag löser onboarding, motiverar valet med analys, säljer projekt plus support, hanterar DPA/scope och mäter sparad tid."],
    [riskAgreementMix]
  )
};
